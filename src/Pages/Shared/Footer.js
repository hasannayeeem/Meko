...
const Footer = () => {
    return (
        ...
        <footer className="">
            <div className='grid grid-cols-1 gap-10 lg:p-20 p-10 bg-accent text-white lg:grid-cols-3'>
                <div className=''>
                    ...
                    <div className='flex'>
                        <img className='lg:h-10 h-5 w-8 lg:w-14 rounded ml-1' src='https://usa.visa.com/dam/VCOM/regional/ve/romania/blogs/hero-image/visa-logo-800x450.jpg' alt=''></img>
                        <img className='lg:h-10 h-5 w-8 lg:w-14 rounded ml-1' src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQnrIe-OfO-NGyPCNEvzu6mfQXCf6YWfbQt4w&usqp=CAU' alt=''></img>
                        <img className='lg:h-10 h-5 w-8 lg:w-14 rounded ml-1' src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTMMMBZ7pEhP9XcipgVOFDFXogo1F7gTtlNTW3m6mvGacClNc6ZLDvJyD8LxEFCYW3Bcl4&usqp=CAU' alt=''></img>
                        <img className='lg:h-10 h-5 w-8 lg:w-14 rounded ml-1' src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRNDJA6nsAFc1W6mcoqsp72ARJb2IZKX1wHDYr8UHZsy0DOJF6p-PrRPo109_j0uaz8Qeg&usqp=CAU' alt=''></img>
                        <img className='lg:h-10 h-5 w-8 lg:w-14 rounded ml-1' src='https://www.investopedia.com/thmb/jXHWp56gMqrRjSpZu3qoDSeGt1w=/735x0/Discover-logo-28a70026a79d4023adafb0f5e2e773cf.jpg' alt=''></img>
                    </div>
                </div>
                <div  className=''>
                    ...
                    <div>
                        ...
                        <div className="form-control lg:w-80">
                            ...
                            <div className="relative">
                                ...
                                <button className="btn btn-primary text-white bg-gradient-to-l from-secondary to-primary hover:bg-gradient-to-r from-primary to-secondary absolute top-0 right-0 rounded-l-none">Subscribe</button>
                            </div>
                        </div>
                    </div>
                </div>
