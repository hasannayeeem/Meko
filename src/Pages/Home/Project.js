...
const Project = ({ project }) => {
    ...
    return (
        <div className="h-[343px]  lg:h-[212px]  xl:h-[262px] relative justify-center items-center flex project-image" style={{
            ...
            <div className='h-[343px]  lg:h-[212px]  xl:h-[262px] w-full flex justify-center items-center z-[100] project-overley-body'>
                <div className='h-0 w-0 flex justify-center items-center text-center z-[1000] project-overley' style={{ background: "rgba(0, 0, 0, 0.5)" }}>
