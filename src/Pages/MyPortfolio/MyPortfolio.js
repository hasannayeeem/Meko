...
const MyPortfolio = () => {
    return (
        <div className='lg:px-20 px-8 py-12 pb-32'>
            <div className="text-5xl py-12 text-accent text-center">About Me</div>
            <div className="text-3xl text-accent font-semibold py-3">Personal Info</div>
